...
const data: Profile = {
  name: "Omhar Regidor",
  role: "Agentic Engineer \\ Software Developer",
  location: "Batangas, Philippines",
  photoSrc: "/omhar/me-pro-image-crop.jpg",
  bioParagraphs: [
    "Omhar Regidor is a Software Developer and emerging Agentic Engineer building systems that combine software, automation, and AI-driven workflows. He focuses on scalable digital solutions that help startups and MSMEs operate more efficiently and grow faster.",
